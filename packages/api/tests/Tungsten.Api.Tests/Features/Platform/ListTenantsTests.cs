...
public class ListTenantsTests
{
    ...
    public async Task Handle_ReturnsTenants_WithCounts()
    {
        ...
        db.Users.Add(new UserEntity { Id = userId, IdentityUserId = "auth0|1", Email = "a@a.com", DisplayName = "A", Role = "SUPPLIER", TenantId = tenantId, IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
