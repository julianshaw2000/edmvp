...
describe('Admin MCP Tools', () => {
  ...
  beforeEach(() => {
    ...
    registerTenantTools(server as any, api);
    registerUserTools(server as any, api);
    registerAnalyticsTools(server as any, api);
    registerAuditTools(server as any, api);
    registerRmapTools(server as any, api);
