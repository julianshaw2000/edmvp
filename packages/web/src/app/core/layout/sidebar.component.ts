  ...
  template: `
    <aside class="w-64 bg-slate-900 text-white min-h-screen flex flex-col">
      ...
      <div class="px-5 py-5 border-b border-slate-700/50">
        <img src="assets/auditraks-logo.png" alt="auditraks" class="h-8 brightness-0 invert" />
      </div>
      ...
      case 'BUYER':
        return [{
          ...
          items: [
            ...
            { label: 'Form SD', route: '/buyer/form-sd', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>' },
