...
public class UpdateUserRoleEnforcementTests
{
    ...
    public async Task TenantAdmin_CannotEscalateToAdmin()
    {
        ...
        db.Users.Add(new UserEntity { Id = callerId, IdentityUserId = "auth0|caller", Email = "c@t.com", DisplayName = "C", Role = "TENANT_ADMIN", TenantId = tenantId, IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
        db.Users.Add(new UserEntity { Id = targetId, IdentityUserId = "auth0|target", Email = "t@t.com", DisplayName = "T", Role = "SUPPLIER", TenantId = tenantId, IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
    ...
    public async Task TenantAdmin_CannotModifyOtherTenantAdmin()
    {
        ...
        db.Tenants.Add(new TenantEntity { Id = tenantId, Name = "T", SchemaPrefix = "t", Status = "ACTIVE", CreatedAt = DateTime.UtcNow });
        db.Users.Add(new UserEntity { Id = callerId, IdentityUserId = "auth0|caller", Email = "c@t.com", DisplayName = "C", Role = "TENANT_ADMIN", TenantId = tenantId, IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
        db.Users.Add(new UserEntity { Id = targetId, IdentityUserId = "auth0|target", Email = "t@t.com", DisplayName = "T", Role = "TENANT_ADMIN", TenantId = tenantId, IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
        await db.SaveChangesAsync();
