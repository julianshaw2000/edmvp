    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      @if (isPlatformAdmin()) {
        ...
        >
          ...
          <div>
            <p class="font-semibold text-slate-900 text-sm">AI Insights</p>
            <p class="text-xs text-slate-500 mt-0.5">Churn, health &amp; revenue AI</p>
          </div>
        </a>
      }
      ...
      <a
        ...
        class="flex items-center gap-4 p-5 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-sky-300 hover:shadow-md transition-all duration-200 group"
      >
        ...
        <div>
          <p class="font-semibold text-slate-900 text-sm">Analytics</p>
