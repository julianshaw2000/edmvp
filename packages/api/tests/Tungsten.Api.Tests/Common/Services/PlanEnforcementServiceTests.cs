...
public class PlanEnforcementServiceTests
{
    ...
    public async Task CheckBatchLimit_UnderLimit_ReturnsNull()
    {
        ...
        db.Users.Add(new UserEntity { Id = userId, Auth0Sub = "a", Email = "a@a.com", DisplayName = "A", Role = "SUPPLIER", TenantId = tenantId, IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
    ...
    public async Task CheckUserLimit_AtLimit_ReturnsError()
    {
        ...
        db.Users.Add(new UserEntity { Id = Guid.NewGuid(), Auth0Sub = "a", Email = "a@a.com", DisplayName = "A", Role = "SUPPLIER", TenantId = tenantId, IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
        await db.SaveChangesAsync();
